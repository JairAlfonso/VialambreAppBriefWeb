...
{
    public class AsesorRegisterModel : PageModel
    {
        ...
        public AsesorRegisterModel(UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager, IToastNotification notify, IMapper mapper)
        {
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            if (UserInputVM.Document != null || UserInputVM.Email != null)
            {
                ...
                string roleToAdd = role != "" ? role : RolesApp.Asesor;
