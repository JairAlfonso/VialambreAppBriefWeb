...
namespace VialambreAppTest1.Pages.Briefs.Employee.Costos
{
    public class EditarRespuestaModel : PageModel
    {
        ...
        public EditarRespuestaModel(BriefService briefService, IToastNotification notify, IWebHostEnvironment host)
        {
        ...
        {
            var filerespuestacostos = HttpContext.Request.Form.Files["FileRespCostos"];

            if (filerespuestacostos! != null)
            {
                ...
                ////Codigo para guardar acrhivos en bucket aws
                ...
                string ArchivosRespuestaCostosFolder = @"Images\ArchivosRespuestaCostos";
                string UploadFolder = Path.Combine(webroot, ArchivosRespuestaCostosFolder);

                brief.ValorTotalCotizado = BriefVM!.ValorTotalCotizado;
                ...
                string fileNewName = await FileManager.CopyFileCostos(filerespuestacostos!, UploadFolder);
                brief.RespuestaCostosInput = Path.Combine(ArchivosRespuestaCostosFolder, fileNewName);

                //Codigo para guardar en bucket aws
                ...
                //// Almacena el enlace a este archivo en tu modelo o base de datos
            ...
            else
            {
                ...
                return RedirectToPage("/Briefs/Employee/Costos/EditarRespuesta", new { briefid = BriefDetails!.BriefId });
            }
