...
{
    public class AgregarPiezaModel : PageModel
    {
        ...
        public AgregarPiezaModel(BriefService briefService, IToastNotification notify, IWebHostEnvironment host)
        {
        ...
        public async Task<IActionResult> OnPostAgregarPiezaAsync(int briefid)
        {
            ...
            var filePieza = PiezaDetails!.FilePieza;
            ...
            if (PiezaDetails != null)
            {
                var pieza = new Pieza
                {
                    ...
                    FilePieza = PiezaDetails.FilePieza,
                    ArchivoPieza = PiezaDetails.ArchivoPieza
                };

                if (PiezaDetails.Publicidad == false)
                {
                    ...
                    pieza.AcabadosyAccesoriosInput = "No requiere";
                }

                if (PiezaDetails.FilePieza != null)
                {
                ...
                else if (PiezaDetails.FilePieza == null)
                {
                ...
                if (string.IsNullOrEmpty(PiezaDetails.PiezaName) || PiezaDetails.Cargue == null)
                {
                    ...
                    RedirectToPage("/Briefs/Client/AgregarPieza", new { briefid = BriefDetails!.BriefId });
                }
                else
                {
                    ...
                    return RedirectToPage("/Briefs/Client/BriefReadOnly", new { briefid = pieza.BriefId });
                }
        ...
        //        {
        //            pieza.Publicidad = false;
        //            pieza.PublicidadAlto = "0";
        //            pieza.PublicidadAncho = "0";
        //            pieza.Tintas = "No requiere";
        //            pieza.AcabadoInput = "No requiere";
        //        }
        ...
        //    {
        //        _notify.AddErrorToastMessage("La pieza no puede estar vacía");
        //        RedirectToPage("/Briefs/Client/AgregarPieza", new { briefid = PiezaDetails!.BriefId });
        //    }
