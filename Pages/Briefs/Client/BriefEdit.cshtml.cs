...
{
    public class BriefEditModel : PageModel
    {
        ...
        public BriefEditModel(UserManager<AppUser> userManager, BriefService briefService, IWebHostEnvironment host, IToastNotification notify)
        {
        ...
        public async Task<IActionResult> OnGet(int id)
        {
            ...
            BriefVM = new BriefVM
            {
                ...
                AgregarNuevoCliente = BriefDetails.AgregarNuevoCliente,
                NewClientFullName = BriefDetails.NewClientFullName,
                NewClientDocument = BriefDetails.NewClientDocument,
                ...
                ProductoInput = BriefDetails.ProductoInput,
            ...
            {
                BriefDetails.NewLugarEntrega = false;
            };
        ...
        public async Task<IActionResult> OnGetEliminarArchivoCostos(int id)
        {
            ...
            if (User.IsInRole("Asesor"))
            {
                ...
                {                    
                    ...
                    _notify.AddWarningToastMessage("Archivo para costos eliminado!!");
                    return RedirectToPage("/Briefs/Client/BriefEdit", new { id = brief.BriefId });
                }
                else
                {
        ...
        public async Task<IActionResult> OnGetEliminarArchivoDesign(int id)
        {
            ...
            if (User.IsInRole("Asesor"))
            {
                ...
                if (brief != null && !string.IsNullOrEmpty(brief.ArchivosDesign))
                {
                    ...
                    // Redirige de vuelta a la página de briefedit
                    _notify.AddWarningToastMessage("Archivo para diseño eliminado!!");
                    return RedirectToPage("/Briefs/Client/BriefEdit", new { id = brief.BriefId });
                }
                else
                {
        ...
        public async Task<IActionResult> OnPostAsync(int briefid)
        {
            ...
            brief.NewClientFullName = BriefVM!.NewClientFullName;
            brief.NewClientDocument = BriefVM!.NewClientDocument;
            brief.ClientFullName = BriefVM!.ClientFullName;
            brief.ClientDocument = BriefVM!.ClientDocument;

            brief.TipoCotizacion = BriefVM.TipoCotizacion;
            brief.Title = BriefVM!.Title;
            brief.Marca = BriefVM!.Marca;
            brief.Description = BriefVM!.Description;
            brief.Producto = BriefVM!.Producto;
            brief.NewProducto = Request.Form.ContainsKey("NewProduct");
            brief.FechaRequerida = BriefVM!.FechaRequerida;
            brief.EntregarEn = BriefVM!.EntregarEn;
            brief.NewLugarEntrega = Request.Form.ContainsKey("NewLugarEntrega");
            brief.ComentariosAdicionales = BriefVM!.ComentariosAdicionales;

            brief.Design = BriefVM.Design;
            brief.Linea = BriefVM!.Linea;
            ...
            brief.Instalacion = BriefVM!.Instalacion;
            brief.DireccionInstalacion = BriefDetails!.DireccionInstalacion;

            brief.EsCanalVenta = Request.Form.ContainsKey("EsCanalVenta");
            brief.CanalVenta = BriefVM.CanalVenta;
            brief.CanalVentaInput = BriefVM.CanalVentaInput;
            brief.TipoEmpaque = BriefVM!.TipoEmpaque;
            brief.NewEmpaque = Request.Form.ContainsKey("NewEmpaque");
            brief.PresupuestoUnidad = BriefVM.PresupuestoUnidad;

            brief.Costos = BriefVM.Costos;
            brief.ArchivosCostosExist = Request.Form.ContainsKey("ArchivosCostosExist");
            brief.FileCostos = BriefVM!.FileCostos;
            brief.ArchivosCostos = BriefVM!.ArchivosCostos;
            brief.ArchivosDesignExist = Request.Form.ContainsKey("ArchivosDesignExist");
            brief.FileDesign = BriefVM!.FileDesign;
            brief.ArchivosDesign = BriefVM!.ArchivosDesign;
            brief.ImageUrlExist = Request.Form.ContainsKey("ImageUrlExist");
            brief.FileOtros = BriefVM!.FileOtros;
            brief.ImageUrl = BriefVM!.ImageUrl;
            ...
            brief.StatusCostos = brief.StatusCostos;
            ...
            ////Codigo para guardar archivos en bucket de aws
            ...
            //    //Almacena el enlace a este archivo en el modelo o base de datos
            //    var enlaceArchivo = $"https://{awsBucketName}.s3.amazonaws.com/{fileUploadRequest.Key}";
            ...
            // Verifica si se han cargado archivos para costos 
            if (brief.ArchivosCostosExist == true && BriefVM.FileCostos != null)
            {
            ...
            else if (brief.ArchivosCostosExist == true && BriefVM.ArchivosCostos == null)
            {
                brief.ArchivosCostosExist = false;
            }

            // Verifica si se han cargado archivos para diseño 
            if (brief.ArchivosDesignExist == true && BriefVM.FileDesign != null)
            {
            ...
            else if (brief.ArchivosDesignExist == true && BriefVM.ArchivosDesign == null)
            {
                brief.ArchivosDesignExist = false;
            }

            // Verifica si se han cargado otros archivos 
            if (brief.ImageUrlExist == true && BriefVM.FileOtros != null)
            {
                string fileNewName = await FileManager.CopyFile(files!, UploadFolder);
                brief.ImageUrl = Path.Combine(ImageFolder, fileNewName);
            }
            else if (brief.ImageUrlExist == true && BriefVM.ImageUrl == null)
            {
                brief.ImageUrlExist = false;
            }
            ...
            {
                brief.CanalVentaInput ??= "Moderno";
                brief.CanalVenta = brief!.CanalVentaInput;
            }
            else
            {
            ...
            if (brief.AgregarNuevoCliente == true)
            {
                ...
                brief.AgregarNuevoCliente = true;
            ...
            await _briefService.UpdateBriefAsync(brief);
            _notify.AddSuccessToastMessage("Cotización actualizada!!");
