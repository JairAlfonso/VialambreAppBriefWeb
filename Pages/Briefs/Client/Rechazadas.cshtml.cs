...
namespace VialambreAppTest1.Pages.Briefs.Client
{
    public class RechazadasModel : PageModel
    {
        ...
        public IEnumerable<Brief>? Rechazadas { get; set; }

        [BindProperty]
        public LoginVM? LoginVM { get; set; }

        public RechazadasModel(UserManager<AppUser> userManager, IToastNotification notify, BriefService briefService)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user != null)
            {
                ...
                Rechazadas = await _briefService.GetBriefsRechazadosAsync(user.Id);
            }
            else
            {
